 ...
 * @author erikt
 */
public class JavaAssignmentTwo {       
    public static void main(String[] args)
    {
        //declare array and name the columns and student row
       String students[] = {"Name", "Course 1", "Course 2", "Course 3", "Course 4", "Course 5"};
        //declare multi dementional array with students names and marks beside to be outputted in the chart
       String marks[][] =   {{"Erik", "40", "30", "56", "22", "42"},
                             {"PG13", "80", "60", "68", "82", "76"},
